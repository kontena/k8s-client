RSpec.describe Pharos::Kube::Config do
  ...
  describe '#self.load_file' do
    context 'for a typical kubeadm admin.conf' do
      ...
      it "loads the current context" do
        expect(subject.context).to eq Pharos::Kube::Config::Context.new(
          cluster: 'kubernetes',
      ...
      it "loads the correct cluster" do
        expect(subject.cluster).to eq Pharos::Kube::Config::Cluster.new(
      ...
      it "loads the correct user" do
        expect(subject.user).to eq Pharos::Kube::Config::User.new(
