...
require 'k8s/model/kube_aggregator/apis/apiregistration/v1/api_service'
...
module K8s::Model::KubeAggregator::Apis::Apiregistration::V1
  class APIServiceList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::KubeAggregator::Apis::Apiregistration::V1::APIService)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::KubeAggregator::Apis::Apiregistration::V1::APIService)
    ...
    register_paths ["/apis/apiregistration.k8s.io/v1/apiservices"]
  end
end
