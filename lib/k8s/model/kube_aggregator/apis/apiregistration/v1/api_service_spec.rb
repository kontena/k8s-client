...
require 'k8s/model/kube_aggregator/apis/apiregistration/v1/service_reference'
...
module K8s::Model::KubeAggregator::Apis::Apiregistration::V1
  class APIServiceSpec < K8s::TypedResource
    ...
    # @return [K8s::Model::KubeAggregator::Apis::Apiregistration::V1::ServiceReference]
    attribute :service, K8s::Model::KubeAggregator::Apis::Apiregistration::V1::ServiceReference
