...
module K8s::Model::KubeAggregator::Apis::Apiregistration::V1beta1
  class APIServiceList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::KubeAggregator::Apis::Apiregistration::V1beta1::APIService)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::KubeAggregator::Apis::Apiregistration::V1beta1::APIService)
    ...
    register_paths ["/apis/apiregistration.k8s.io/v1beta1/apiservices"]
  end
end
