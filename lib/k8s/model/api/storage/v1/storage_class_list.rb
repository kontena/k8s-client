...
require 'k8s/model/api/storage/v1/storage_class'
...
module K8s::Model::Api::Storage::V1
  class StorageClassList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Storage::V1::StorageClass)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Storage::V1::StorageClass)
    ...
    register_paths ["/apis/storage.k8s.io/v1/storageclasses"]
  end
end
