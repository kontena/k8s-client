...
require 'k8s/model/api/storage/v1alpha1/volume_attachment_source'
...
module K8s::Model::Api::Storage::V1alpha1
  class VolumeAttachmentSpec < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Storage::V1alpha1::VolumeAttachmentSource]
    attribute :source, K8s::Model::Api::Storage::V1alpha1::VolumeAttachmentSource
