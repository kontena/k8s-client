...
require 'k8s/model/api/storage/v1alpha1/volume_error'

module K8s::Model::Api::Storage::V1alpha1
  class VolumeAttachmentStatus < K8s::TypedResource
    # The last error encountered during attach operation, if any. This field must only be set by the entity completing the attach operation, i.e. the external-attacher.
    # @return [K8s::Model::Api::Storage::V1alpha1::VolumeError,NilClass]
    attribute :attachError, K8s::Model::Api::Storage::V1alpha1::VolumeError.optional.default(nil)
    ...
    # @return [K8s::Model::Api::Storage::V1alpha1::VolumeError,NilClass]
    attribute :detachError, K8s::Model::Api::Storage::V1alpha1::VolumeError.optional.default(nil)
