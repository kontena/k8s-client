...
require 'k8s/model/api/storage/v1alpha1/volume_attachment_spec'
require 'k8s/model/api/storage/v1alpha1/volume_attachment_status'
...
module K8s::Model::Api::Storage::V1alpha1
  class VolumeAttachment < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Storage::V1alpha1::VolumeAttachmentSpec]
    attribute :spec, K8s::Model::Api::Storage::V1alpha1::VolumeAttachmentSpec
