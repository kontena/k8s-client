...
require 'k8s/model/api/storage/v1beta1/volume_attachment'
...
module K8s::Model::Api::Storage::V1beta1
  class VolumeAttachmentList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Storage::V1beta1::VolumeAttachment)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Storage::V1beta1::VolumeAttachment)
    ...
    register_paths ["/apis/storage.k8s.io/v1beta1/volumeattachments"]
  end
end
