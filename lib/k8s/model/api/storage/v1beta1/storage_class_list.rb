...
require 'k8s/model/api/storage/v1beta1/storage_class'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Storage::V1beta1
  class StorageClassList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Storage::V1beta1::StorageClass)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Storage::V1beta1::StorageClass)
    ...
    register_paths ["/apis/storage.k8s.io/v1beta1/storageclasses"]
  end
end
