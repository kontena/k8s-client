...
module K8s::Model::Api::Coordination::V1beta1
  class LeaseList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Coordination::V1beta1::Lease)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Coordination::V1beta1::Lease)
    ...
    register_paths ["/apis/coordination.k8s.io/v1beta1/leases","/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases"]
  end
end
