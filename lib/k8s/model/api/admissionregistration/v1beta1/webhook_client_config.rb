...
require 'k8s/model/api/admissionregistration/v1beta1/service_reference'
...
module K8s::Model::Api::Admissionregistration::V1beta1
  class WebhookClientConfig < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Admissionregistration::V1beta1::ServiceReference,NilClass]
    attribute :service, K8s::Model::Api::Admissionregistration::V1beta1::ServiceReference.optional.default(nil)
