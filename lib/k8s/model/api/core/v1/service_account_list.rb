...
require 'k8s/model/api/core/v1/service_account'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Core::V1
  class ServiceAccountList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::ServiceAccount)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::ServiceAccount)
    ...
    register_paths ["/api/v1/namespaces/{namespace}/serviceaccounts","/api/v1/serviceaccounts"]
  end
end
