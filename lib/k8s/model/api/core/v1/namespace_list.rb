...
require 'k8s/model/api/core/v1/namespace'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Core::V1
  class NamespaceList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::Namespace)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::Namespace)
    ...
    register_paths ["/api/v1/namespaces"]
  end
end
