...
require 'k8s/model/api/core/v1/pod'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Core::V1
  class PodList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::Pod)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::Pod)
    ...
    register_paths ["/api/v1/namespaces/{namespace}/pods","/api/v1/pods"]
  end
end
