...
require 'k8s/model/api/core/v1/endpoint_subset'

module K8s::Model::Api::Core::V1
  class Endpoints < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::EndpointSubset),NilClass]
    attribute :subsets, K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::EndpointSubset).optional.default(nil)
