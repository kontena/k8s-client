...
require 'k8s/model/api/core/v1/service'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Core::V1
  class ServiceList < K8s::TypedResource
    ...
    # List of services
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::Service)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::Service)
    ...
    register_paths ["/api/v1/namespaces/{namespace}/services","/api/v1/services"]
  end
end
