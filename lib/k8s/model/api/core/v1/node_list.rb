...
require 'k8s/model/api/core/v1/node'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Core::V1
  class NodeList < K8s::TypedResource
    ...
    # List of nodes
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::Node)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::Node)
