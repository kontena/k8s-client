...
require 'k8s/model/api/core/v1/component_status'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Core::V1
  class ComponentStatusList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::ComponentStatus)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::ComponentStatus)
    ...
    register_paths ["/api/v1/componentstatuses"]
  end
end
