...
require 'k8s/model/api/core/v1/pod_template'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Core::V1
  class PodTemplateList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::PodTemplate)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::PodTemplate)
    ...
    register_paths ["/api/v1/namespaces/{namespace}/podtemplates","/api/v1/podtemplates"]
  end
end
