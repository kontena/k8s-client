...
module K8s::Model::Api::Core::V1
  class ScaleIOVolumeSource < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Core::V1::LocalObjectReference]
    attribute :secretRef, K8s::Model::Api::Core::V1::LocalObjectReference
