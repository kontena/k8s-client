...
require 'k8s/model/api/core/v1/event'
...
module K8s::Model::Api::Core::V1
  class EventList < K8s::TypedResource
    ...
    # List of events
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::Event)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::Event)
    ...
    register_paths ["/api/v1/events","/api/v1/namespaces/{namespace}/events"]
  end
end
