...
require 'k8s/model/api/core/v1/pod_status'

module K8s::Model::Api::Core::V1
  class Pod < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Core::V1::PodStatus,NilClass]
    attribute :status, K8s::Model::Api::Core::V1::PodStatus.optional.default(nil)

    register_paths ["/api/v1/namespaces/{namespace}/pods/{name}","/api/v1/namespaces/{namespace}/pods/{name}/status"]
  end
end
