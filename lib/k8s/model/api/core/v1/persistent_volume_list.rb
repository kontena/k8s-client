...
require 'k8s/model/api/core/v1/persistent_volume'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Core::V1
  class PersistentVolumeList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::PersistentVolume)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::PersistentVolume)
    ...
    register_paths ["/api/v1/persistentvolumes"]
  end
end
