...
require 'k8s/model/api/core/v1/component_condition'
require 'k8s/model/apimachinery/apis/meta/v1/object_meta'

module K8s::Model::Api::Core::V1
  class ComponentStatus < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::ComponentCondition),NilClass]
    attribute :conditions, K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::ComponentCondition).optional.default(nil)
    ...
    register_paths ["/api/v1/componentstatuses/{name}"]
  end
end
