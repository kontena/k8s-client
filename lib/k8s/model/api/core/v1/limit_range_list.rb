...
require 'k8s/model/api/core/v1/limit_range'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Core::V1
  class LimitRangeList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::LimitRange)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::LimitRange)
    ...
    register_paths ["/api/v1/limitranges","/api/v1/namespaces/{namespace}/limitranges"]
  end
end
