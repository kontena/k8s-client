...
require 'k8s/model/api/core/v1/endpoints'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Core::V1
  class EndpointsList < K8s::TypedResource
    ...
    # List of endpoints.
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::Endpoints)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Core::V1::Endpoints)
    ...
    register_paths ["/api/v1/endpoints","/api/v1/namespaces/{namespace}/endpoints"]
  end
end
