...
require 'k8s/model/api/batch/v2alpha1/job_template_spec'
...
module K8s::Model::Api::Batch::V2alpha1
  class CronJobSpec < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Batch::V2alpha1::JobTemplateSpec]
    attribute :jobTemplate, K8s::Model::Api::Batch::V2alpha1::JobTemplateSpec
