...
require 'k8s/model/api/batch/v1beta1/cron_job'
...
module K8s::Model::Api::Batch::V1beta1
  class CronJobList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Batch::V1beta1::CronJob)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Batch::V1beta1::CronJob)
    ...
    register_paths ["/apis/batch/v1beta1/cronjobs","/apis/batch/v1beta1/namespaces/{namespace}/cronjobs"]
  end
end
