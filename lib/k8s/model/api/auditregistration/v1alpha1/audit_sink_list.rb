...
module K8s::Model::Api::Auditregistration::V1alpha1
  class AuditSinkList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Auditregistration::V1alpha1::AuditSink)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Auditregistration::V1alpha1::AuditSink)
    ...
    register_paths ["/apis/auditregistration.k8s.io/v1alpha1/auditsinks"]
  end
end
