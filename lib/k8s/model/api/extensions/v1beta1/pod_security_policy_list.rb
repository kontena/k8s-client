...
require 'k8s/model/api/extensions/v1beta1/pod_security_policy'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Extensions::V1beta1
  class PodSecurityPolicyList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Extensions::V1beta1::PodSecurityPolicy)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Extensions::V1beta1::PodSecurityPolicy)
    ...
    register_paths ["/apis/extensions/v1beta1/podsecuritypolicies"]
  end
end
