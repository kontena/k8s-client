...
module K8s::Model::Api::Extensions::V1beta1
  class IngressList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Extensions::V1beta1::Ingress)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Extensions::V1beta1::Ingress)
    ...
    register_paths ["/apis/extensions/v1beta1/ingresses","/apis/extensions/v1beta1/namespaces/{namespace}/ingresses"]
  end
end
