...
require 'k8s/model/api/extensions/v1beta1/network_policy'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Extensions::V1beta1
  class NetworkPolicyList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Extensions::V1beta1::NetworkPolicy)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Extensions::V1beta1::NetworkPolicy)
    ...
    register_paths ["/apis/extensions/v1beta1/namespaces/{namespace}/networkpolicies","/apis/extensions/v1beta1/networkpolicies"]
  end
end
