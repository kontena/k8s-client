...
require 'k8s/model/api/extensions/v1beta1/deployment'
...
module K8s::Model::Api::Extensions::V1beta1
  class DeploymentList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Extensions::V1beta1::Deployment)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Extensions::V1beta1::Deployment)
    ...
    register_paths ["/apis/extensions/v1beta1/deployments","/apis/extensions/v1beta1/namespaces/{namespace}/deployments"]
  end
end
