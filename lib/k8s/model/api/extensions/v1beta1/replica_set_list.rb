...
require 'k8s/model/api/extensions/v1beta1/replica_set'
...
module K8s::Model::Api::Extensions::V1beta1
  class ReplicaSetList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Extensions::V1beta1::ReplicaSet)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Extensions::V1beta1::ReplicaSet)
    ...
    register_paths ["/apis/extensions/v1beta1/namespaces/{namespace}/replicasets","/apis/extensions/v1beta1/replicasets"]
  end
end
