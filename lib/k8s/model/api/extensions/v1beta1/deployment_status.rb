...
require 'k8s/model/api/extensions/v1beta1/deployment_condition'
...
module K8s::Model::Api::Extensions::V1beta1
  class DeploymentStatus < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Extensions::V1beta1::DeploymentCondition),NilClass]
    attribute :conditions, K8s::API::Types::Array.of(K8s::Model::Api::Extensions::V1beta1::DeploymentCondition).optional.default(nil)
