...
require 'k8s/model/api/extensions/v1beta1/replica_set_condition'
...
module K8s::Model::Api::Extensions::V1beta1
  class ReplicaSetStatus < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Extensions::V1beta1::ReplicaSetCondition),NilClass]
    attribute :conditions, K8s::API::Types::Array.of(K8s::Model::Api::Extensions::V1beta1::ReplicaSetCondition).optional.default(nil)
