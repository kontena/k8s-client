...
require 'k8s/model/api/extensions/v1beta1/network_policy_spec'
...
module K8s::Model::Api::Extensions::V1beta1
  class NetworkPolicy < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Extensions::V1beta1::NetworkPolicySpec,NilClass]
    attribute :spec, K8s::Model::Api::Extensions::V1beta1::NetworkPolicySpec.optional.default(nil)

    register_paths ["/apis/extensions/v1beta1/namespaces/{namespace}/networkpolicies/{name}"]
  end
end
