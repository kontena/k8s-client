...
require 'k8s/model/api/extensions/v1beta1/daemon_set_update_strategy'
...
module K8s::Model::Api::Extensions::V1beta1
  class DaemonSetSpec < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Integer,NilClass]
    attribute :templateGeneration, K8s::API::Types::Integer.optional.default(nil)

    # An update strategy to replace existing DaemonSet pods with new pods.
    # @return [K8s::Model::Api::Extensions::V1beta1::DaemonSetUpdateStrategy,NilClass]
    attribute :updateStrategy, K8s::Model::Api::Extensions::V1beta1::DaemonSetUpdateStrategy.optional.default(nil)
