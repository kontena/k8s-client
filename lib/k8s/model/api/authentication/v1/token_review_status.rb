...
require 'k8s/model/api/authentication/v1/user_info'
...
module K8s::Model::Api::Authentication::V1
  class TokenReviewStatus < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Authentication::V1::UserInfo,NilClass]
    attribute :user, K8s::Model::Api::Authentication::V1::UserInfo.optional.default(nil)
