...
require "k8s/model/api/authentication/v1"
require 'k8s/model/apimachinery/apis/meta/v1/object_meta'
require 'k8s/model/api/authentication/v1/token_review_spec'
require 'k8s/model/api/authentication/v1/token_review_status'

module K8s::Model::Api::Authentication::V1
  class TokenReview < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Authentication::V1::TokenReviewSpec]
    attribute :spec, K8s::Model::Api::Authentication::V1::TokenReviewSpec
