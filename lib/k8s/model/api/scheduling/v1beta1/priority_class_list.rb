...
require 'k8s/model/api/scheduling/v1beta1/priority_class'
...
module K8s::Model::Api::Scheduling::V1beta1
  class PriorityClassList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Scheduling::V1beta1::PriorityClass)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Scheduling::V1beta1::PriorityClass)
    ...
    register_paths ["/apis/scheduling.k8s.io/v1beta1/priorityclasses"]
  end
end
