...
require 'k8s/model/api/certificates/v1beta1/certificate_signing_request'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Certificates::V1beta1
  class CertificateSigningRequestList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Certificates::V1beta1::CertificateSigningRequest)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Certificates::V1beta1::CertificateSigningRequest)
