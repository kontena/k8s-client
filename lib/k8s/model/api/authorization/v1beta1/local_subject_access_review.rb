...
require 'k8s/model/api/authorization/v1beta1/subject_access_review_spec'
...
module K8s::Model::Api::Authorization::V1beta1
  class LocalSubjectAccessReview < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Authorization::V1beta1::SubjectAccessReviewSpec]
    attribute :spec, K8s::Model::Api::Authorization::V1beta1::SubjectAccessReviewSpec
