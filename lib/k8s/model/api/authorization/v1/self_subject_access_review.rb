...
require 'k8s/model/api/authorization/v1/self_subject_access_review_spec'
...
module K8s::Model::Api::Authorization::V1
  class SelfSubjectAccessReview < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Authorization::V1::SelfSubjectAccessReviewSpec]
    attribute :spec, K8s::Model::Api::Authorization::V1::SelfSubjectAccessReviewSpec
