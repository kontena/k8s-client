...
require 'k8s/model/api/policy/v1beta1/pod_security_policy'
...
module K8s::Model::Api::Policy::V1beta1
  class PodSecurityPolicyList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Policy::V1beta1::PodSecurityPolicy)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Policy::V1beta1::PodSecurityPolicy)
    ...
    register_paths ["/apis/policy/v1beta1/podsecuritypolicies"]
  end
end
