...
require 'k8s/model/api/networking/v1/ip_block'
...
module K8s::Model::Api::Networking::V1
  class NetworkPolicyPeer < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Networking::V1::IPBlock,NilClass]
    attribute :ipBlock, K8s::Model::Api::Networking::V1::IPBlock.optional.default(nil)
