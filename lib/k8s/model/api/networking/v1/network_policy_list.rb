...
require 'k8s/model/api/networking/v1/network_policy'
...
module K8s::Model::Api::Networking::V1
  class NetworkPolicyList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Networking::V1::NetworkPolicy)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Networking::V1::NetworkPolicy)
    ...
    register_paths ["/apis/networking.k8s.io/v1/namespaces/{namespace}/networkpolicies","/apis/networking.k8s.io/v1/networkpolicies"]
  end
end
