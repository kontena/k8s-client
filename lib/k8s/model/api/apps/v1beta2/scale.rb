...
require 'k8s/model/api/apps/v1beta2/scale_spec'
require 'k8s/model/api/apps/v1beta2/scale_status'
...
module K8s::Model::Api::Apps::V1beta2
  class Scale < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Apps::V1beta2::ScaleSpec,NilClass]
    attribute :spec, K8s::Model::Api::Apps::V1beta2::ScaleSpec.optional.default(nil)
