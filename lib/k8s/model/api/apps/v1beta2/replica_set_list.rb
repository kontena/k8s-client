...
require 'k8s/model/api/apps/v1beta2/replica_set'
...
module K8s::Model::Api::Apps::V1beta2
  class ReplicaSetList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta2::ReplicaSet)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta2::ReplicaSet)
    ...
    register_paths ["/apis/apps/v1beta2/namespaces/{namespace}/replicasets","/apis/apps/v1beta2/replicasets"]
  end
end
