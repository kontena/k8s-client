...
require 'k8s/model/api/apps/v1beta2/stateful_set_update_strategy'
...
module K8s::Model::Api::Apps::V1beta2
  class StatefulSetSpec < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Apps::V1beta2::StatefulSetUpdateStrategy,NilClass]
    attribute :updateStrategy, K8s::Model::Api::Apps::V1beta2::StatefulSetUpdateStrategy.optional.default(nil)
