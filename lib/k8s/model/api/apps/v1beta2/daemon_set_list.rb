...
require 'k8s/model/api/apps/v1beta2/daemon_set'
...
module K8s::Model::Api::Apps::V1beta2
  class DaemonSetList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta2::DaemonSet)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta2::DaemonSet)
    ...
    register_paths ["/apis/apps/v1beta2/daemonsets","/apis/apps/v1beta2/namespaces/{namespace}/daemonsets"]
  end
end
