...
require 'k8s/model/api/apps/v1beta2/stateful_set_condition'
...
module K8s::Model::Api::Apps::V1beta2
  class StatefulSetStatus < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta2::StatefulSetCondition),NilClass]
    attribute :conditions, K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta2::StatefulSetCondition).optional.default(nil)
