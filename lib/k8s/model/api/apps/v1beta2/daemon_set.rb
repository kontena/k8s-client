...
require 'k8s/model/api/apps/v1beta2/daemon_set_spec'
require 'k8s/model/api/apps/v1beta2/daemon_set_status'
...
module K8s::Model::Api::Apps::V1beta2
  class DaemonSet < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Apps::V1beta2::DaemonSetSpec,NilClass]
    attribute :spec, K8s::Model::Api::Apps::V1beta2::DaemonSetSpec.optional.default(nil)
