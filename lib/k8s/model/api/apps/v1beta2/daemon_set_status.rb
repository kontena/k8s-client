...
require 'k8s/model/api/apps/v1beta2/daemon_set_condition'
...
module K8s::Model::Api::Apps::V1beta2
  class DaemonSetStatus < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta2::DaemonSetCondition),NilClass]
    attribute :conditions, K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta2::DaemonSetCondition).optional.default(nil)
