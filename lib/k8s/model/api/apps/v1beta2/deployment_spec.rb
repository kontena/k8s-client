...
require 'k8s/model/api/apps/v1beta2/deployment_strategy'
...
module K8s::Model::Api::Apps::V1beta2
  class DeploymentSpec < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Apps::V1beta2::DeploymentStrategy,NilClass]
    attribute :strategy, K8s::Model::Api::Apps::V1beta2::DeploymentStrategy.optional.default(nil)
