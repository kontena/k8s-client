...
require 'k8s/model/api/apps/v1beta2/deployment'
...
module K8s::Model::Api::Apps::V1beta2
  class DeploymentList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta2::Deployment)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta2::Deployment)
    ...
    register_paths ["/apis/apps/v1beta2/deployments","/apis/apps/v1beta2/namespaces/{namespace}/deployments"]
  end
end
