...
require 'k8s/model/api/apps/v1beta2/stateful_set'
...
module K8s::Model::Api::Apps::V1beta2
  class StatefulSetList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta2::StatefulSet)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta2::StatefulSet)
    ...
    register_paths ["/apis/apps/v1beta2/namespaces/{namespace}/statefulsets","/apis/apps/v1beta2/statefulsets"]
  end
end
