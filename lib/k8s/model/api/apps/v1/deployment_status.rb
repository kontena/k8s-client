...
require 'k8s/model/api/apps/v1/deployment_condition'
...
module K8s::Model::Api::Apps::V1
  class DeploymentStatus < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1::DeploymentCondition),NilClass]
    attribute :conditions, K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1::DeploymentCondition).optional.default(nil)
