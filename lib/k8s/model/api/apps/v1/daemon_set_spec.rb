...
require 'k8s/model/api/apps/v1/daemon_set_update_strategy'
...
module K8s::Model::Api::Apps::V1
  class DaemonSetSpec < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Apps::V1::DaemonSetUpdateStrategy,NilClass]
    attribute :updateStrategy, K8s::Model::Api::Apps::V1::DaemonSetUpdateStrategy.optional.default(nil)
