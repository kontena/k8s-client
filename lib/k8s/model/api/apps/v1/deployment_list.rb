...
require 'k8s/model/api/apps/v1/deployment'
...
module K8s::Model::Api::Apps::V1
  class DeploymentList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1::Deployment)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1::Deployment)
    ...
    register_paths ["/apis/apps/v1/deployments","/apis/apps/v1/namespaces/{namespace}/deployments"]
  end
end
