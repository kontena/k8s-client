...
require 'k8s/model/api/apps/v1/daemon_set'
...
module K8s::Model::Api::Apps::V1
  class DaemonSetList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1::DaemonSet)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1::DaemonSet)
