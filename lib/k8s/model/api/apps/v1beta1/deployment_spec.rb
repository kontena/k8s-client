...
require 'k8s/model/api/apps/v1beta1/deployment_strategy'
...
module K8s::Model::Api::Apps::V1beta1
  class DeploymentSpec < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Apps::V1beta1::RollbackConfig,NilClass]
    attribute :rollbackTo, K8s::Model::Api::Apps::V1beta1::RollbackConfig.optional.default(nil)
    ...
    # @return [K8s::Model::Api::Apps::V1beta1::DeploymentStrategy,NilClass]
    attribute :strategy, K8s::Model::Api::Apps::V1beta1::DeploymentStrategy.optional.default(nil)
