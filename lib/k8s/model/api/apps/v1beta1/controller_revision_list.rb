...
require 'k8s/model/api/apps/v1beta1/controller_revision'
...
module K8s::Model::Api::Apps::V1beta1
  class ControllerRevisionList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta1::ControllerRevision)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta1::ControllerRevision)
    ...
    register_paths ["/apis/apps/v1beta1/controllerrevisions","/apis/apps/v1beta1/namespaces/{namespace}/controllerrevisions"]
  end
end
