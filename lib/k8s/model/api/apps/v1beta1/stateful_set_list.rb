...
require 'k8s/model/api/apps/v1beta1/stateful_set'
...
module K8s::Model::Api::Apps::V1beta1
  class StatefulSetList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta1::StatefulSet)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Apps::V1beta1::StatefulSet)
    ...
    register_paths ["/apis/apps/v1beta1/namespaces/{namespace}/statefulsets","/apis/apps/v1beta1/statefulsets"]
  end
end
