...
require 'k8s/model/api/rbac/v1beta1/role_binding'
...
module K8s::Model::Api::Rbac::V1beta1
  class RoleBindingList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Rbac::V1beta1::RoleBinding)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Rbac::V1beta1::RoleBinding)
    ...
    register_paths ["/apis/rbac.authorization.k8s.io/v1beta1/namespaces/{namespace}/rolebindings","/apis/rbac.authorization.k8s.io/v1beta1/rolebindings"]
  end
end
