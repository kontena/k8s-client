...
require 'k8s/model/api/rbac/v1beta1/cluster_role'
...
module K8s::Model::Api::Rbac::V1beta1
  class ClusterRoleList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Rbac::V1beta1::ClusterRole)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Rbac::V1beta1::ClusterRole)
    ...
    register_paths ["/apis/rbac.authorization.k8s.io/v1beta1/clusterroles"]
  end
end
