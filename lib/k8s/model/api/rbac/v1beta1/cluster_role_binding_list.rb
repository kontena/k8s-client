...
require 'k8s/model/api/rbac/v1beta1/cluster_role_binding'
...
module K8s::Model::Api::Rbac::V1beta1
  class ClusterRoleBindingList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Rbac::V1beta1::ClusterRoleBinding)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Rbac::V1beta1::ClusterRoleBinding)
