...
require 'k8s/model/api/rbac/v1alpha1/role'
...
module K8s::Model::Api::Rbac::V1alpha1
  class RoleList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Rbac::V1alpha1::Role)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Rbac::V1alpha1::Role)
    ...
    register_paths ["/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles","/apis/rbac.authorization.k8s.io/v1alpha1/roles"]
  end
end
