...
require 'k8s/model/api/rbac/v1alpha1/cluster_role_binding'
require 'k8s/model/apimachinery/apis/meta/v1/list_meta'

module K8s::Model::Api::Rbac::V1alpha1
  class ClusterRoleBindingList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Rbac::V1alpha1::ClusterRoleBinding)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Rbac::V1alpha1::ClusterRoleBinding)
    ...
    register_paths ["/apis/rbac.authorization.k8s.io/v1alpha1/clusterrolebindings"]
  end
end
