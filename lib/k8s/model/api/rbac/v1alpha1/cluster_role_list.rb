...
require 'k8s/model/api/rbac/v1alpha1/cluster_role'
...
module K8s::Model::Api::Rbac::V1alpha1
  class ClusterRoleList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Rbac::V1alpha1::ClusterRole)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Rbac::V1alpha1::ClusterRole)
    ...
    register_paths ["/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles"]
  end
end
