...
require 'k8s/model/api/rbac/v1/cluster_role_binding'
...
module K8s::Model::Api::Rbac::V1
  class ClusterRoleBindingList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Rbac::V1::ClusterRoleBinding)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Rbac::V1::ClusterRoleBinding)
    ...
    register_paths ["/apis/rbac.authorization.k8s.io/v1/clusterrolebindings"]
  end
end
