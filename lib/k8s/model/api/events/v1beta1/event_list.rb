...
module K8s::Model::Api::Events::V1beta1
  class EventList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Events::V1beta1::Event)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Events::V1beta1::Event)
    ...
    register_paths ["/apis/events.k8s.io/v1beta1/events","/apis/events.k8s.io/v1beta1/namespaces/{namespace}/events"]
  end
end
