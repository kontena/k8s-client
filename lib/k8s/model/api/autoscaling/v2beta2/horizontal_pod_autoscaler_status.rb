...
require 'k8s/model/api/autoscaling/v2beta2/horizontal_pod_autoscaler_condition'
require 'k8s/model/api/autoscaling/v2beta2/metric_status'
...
module K8s::Model::Api::Autoscaling::V2beta2
  class HorizontalPodAutoscalerStatus < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerCondition)]
    attribute :conditions, K8s::API::Types::Array.of(K8s::Model::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerCondition)

    # currentMetrics is the last read state of the metrics used by this autoscaler.
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Autoscaling::V2beta2::MetricStatus),NilClass]
    attribute :currentMetrics, K8s::API::Types::Array.of(K8s::Model::Api::Autoscaling::V2beta2::MetricStatus).optional.default(nil)
