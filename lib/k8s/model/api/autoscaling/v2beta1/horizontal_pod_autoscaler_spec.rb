...
require 'k8s/model/api/autoscaling/v2beta1/metric_spec'
...
module K8s::Model::Api::Autoscaling::V2beta1
  class HorizontalPodAutoscalerSpec < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Autoscaling::V2beta1::MetricSpec),NilClass]
    attribute :metrics, K8s::API::Types::Array.of(K8s::Model::Api::Autoscaling::V2beta1::MetricSpec).optional.default(nil)
    ...
    attribute :scaleTargetRef, K8s::Model::Api::Autoscaling::V2beta1::CrossVersionObjectReference
