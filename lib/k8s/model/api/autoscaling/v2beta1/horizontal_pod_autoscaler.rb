...
require 'k8s/model/api/autoscaling/v2beta1/horizontal_pod_autoscaler_spec'
require 'k8s/model/api/autoscaling/v2beta1/horizontal_pod_autoscaler_status'
...
module K8s::Model::Api::Autoscaling::V2beta1
  class HorizontalPodAutoscaler < K8s::TypedResource
    ...
    # @return [K8s::Model::Api::Autoscaling::V2beta1::HorizontalPodAutoscalerSpec,NilClass]
    attribute :spec, K8s::Model::Api::Autoscaling::V2beta1::HorizontalPodAutoscalerSpec.optional.default(nil)
