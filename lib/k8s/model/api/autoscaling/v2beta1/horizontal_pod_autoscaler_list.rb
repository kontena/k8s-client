...
require 'k8s/model/api/autoscaling/v2beta1/horizontal_pod_autoscaler'
...
module K8s::Model::Api::Autoscaling::V2beta1
  class HorizontalPodAutoscalerList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Autoscaling::V2beta1::HorizontalPodAutoscaler)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Autoscaling::V2beta1::HorizontalPodAutoscaler)
    ...
    register_paths ["/apis/autoscaling/v2beta1/horizontalpodautoscalers","/apis/autoscaling/v2beta1/namespaces/{namespace}/horizontalpodautoscalers"]
  end
end
