...
require 'k8s/model/api/autoscaling/v1/horizontal_pod_autoscaler'
...
module K8s::Model::Api::Autoscaling::V1
  class HorizontalPodAutoscalerList < K8s::TypedResource
    ...
    # @return [K8s::API::Types::Array.of(K8s::Model::Api::Autoscaling::V1::HorizontalPodAutoscaler)]
    attribute :items, K8s::API::Types::Array.of(K8s::Model::Api::Autoscaling::V1::HorizontalPodAutoscaler)
    ...
    register_paths ["/apis/autoscaling/v1/horizontalpodautoscalers","/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers"]
  end
end
