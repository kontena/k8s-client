...
module K8s::Model::Api::Autoscaling::V1
  class HorizontalPodAutoscaler < K8s::TypedResource
    ...
    register_paths ["/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}","/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status"]
  end
end
